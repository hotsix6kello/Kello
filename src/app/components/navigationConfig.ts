export const navItems = [
    ...
    { id: 'search', path: "/explore", icon: "search", labelKey: 'common.explore_nav', defaultLabel: '탐색', activeKey: "/explore" },
    { id: 'talk', path: "/talk/chat?shopId=kello-center", icon: "talk", labelKey: 'common.buddy_nav', defaultLabel: 'Kello톡', activeKey: "/talk" },
