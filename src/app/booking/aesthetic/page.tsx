...
export default function BeautyStoreManagementPage() {
  ...
  // Mock store data — will be replaced by real DB data
  const [stores] = useState<StoreInfo[]>([
    {
      id: 'store-1',
      name: '강남 럭스 에스테틱',
      category: t('categories.esthetic.label'),
    ...
    },
    {
      id: 'store-2',
      name: '순수 헤어 홍대본점',
      category: t('categories.hair.label'),
      location: '서울 마포구 홍대',
      region: 'seoul',
    ...
    },
    {
      id: 'store-3',
      name: '분당 정자 네일 라운지',
      category: t('categories.nail.label'),
      location: '경기 성남시 분당구',
      region: 'gyeonggi',
    ...
    },
    {
      id: 'store-4',
      name: '송도 스파 앤 왁싱',
      category: t('categories.waxing.label'),
      location: '인천 연수구 송도동',
      region: 'incheon',
  ...
  const regionsMap = [
    { id: 'all',      label: t('booking_aesthetic.region_all') },
    { id: 'seoul',    label: t('booking_aesthetic.region_seoul') },
    { id: 'gyeonggi', label: t('booking_aesthetic.region_gyeonggi') },
    { id: 'incheon',  label: t('booking_aesthetic.region_incheon') },
    { id: 'busan',    label: t('booking_aesthetic.region_busan') },
    { id: 'jeju',     label: t('booking_aesthetic.region_jeju') },
  ];
              ...
              filteredStores.map((store) => (
                <div key={store.id} className={styles.storeCard}>
                  <div className={styles.storeHeader}>
                    ...
                    <span className={styles.storeCategoryBadge}>{store.category}</span>
                  </div>
